...
router.route('/foodtracker/mealList',).post( mealList)
router.route('/foodtracker/mealListSearch').post(mealListSearch)
router.route('/foodtracker/recipes').post(recipes)
router.route('/foodtracker/recipeSearch').post(verifyToken,recipeSearch)
router.route('/foodtracker/selectRecipe').post(selectRecipe)
